...
from exame.models import SolicitacaoExame
...
def alterar_dados_exame(request, exame_id):
    ...
    if requer_senha and (not exame.senha):
        messages.add_message(request, constants.ERROR, 'Senha ainda não existe. Por favor crie uma senha.')
